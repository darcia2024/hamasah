...
- **Tahap 7 — LMS:** course, materi, enrollment, progress, dan study-help dasar tersedia. Migrasi 025 menambah attempt kuis, scoring server-side, batas tiga percobaan, dan completion hanya saat nilai lulus. Migrasi 026 menambah submission tugas dan review guru melalui endpoint submission/review, dengan satu submission aktif per materi. Regression test isolasi course, batas attempt, submission duplikat, dan review sudah ada. Media nyata, versi materi, aturan kelulusan lengkap, dan UAT LMS masih perlu ditutup.
