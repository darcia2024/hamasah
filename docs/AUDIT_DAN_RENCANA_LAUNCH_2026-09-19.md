...
- **Tahap 7 — LMS:** course, materi, enrollment, progress, dan study-help dasar tersedia. Migrasi 025 menambah attempt kuis, scoring server-side, batas tiga percobaan, dan completion hanya saat nilai lulus. Endpoint `POST /api/students/:studentId/courses/:courseId/materials/:materialId/attempts` serta regression test isolasi course sudah ada. Media nyata, submission tugas, review guru, versi materi, aturan kelulusan lengkap, dan UAT LMS masih perlu ditutup.
