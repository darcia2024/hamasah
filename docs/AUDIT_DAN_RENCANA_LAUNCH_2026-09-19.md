...
- **Tahap 5 — operasional/keuangan:** fondasi kontrol lokal sudah bertambah lewat migrasi 022: koreksi dan pembatalan invoice berjejak, dokumen serta histori status visa, mutasi inventaris dengan penolakan stok negatif, kapasitas asrama, dan histori perpindahan placement. Endpoint reminder visa berbasis tenggat juga tersedia. Tahap ini masih parsial karena bukti pembayaran/PDF dan nomor verifikasi final belum disepakati, reminder belum dijalankan sebagai job terjadwal, import data belum dibangun, serta UAT peran finance/operations belum dijalankan.
