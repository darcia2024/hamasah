...
- **Tahap 5 — operasional/keuangan:** fondasi kontrol lokal sudah bertambah lewat migrasi 022: koreksi dan pembatalan invoice berjejak, dokumen serta histori status visa, mutasi inventaris dengan penolakan stok negatif, dan kapasitas asrama. Tahap ini masih parsial karena bukti pembayaran/PDF dan nomor verifikasi final belum disepakati, histori perpindahan asrama dan pengingat visa belum menjadi job, import data belum dibangun, serta UAT peran finance/operations belum dijalankan.
